 ...
 * @author Admin
 */
public class Update_HangPhuongTien extends javax.swing.JFrame {
    ...
    public Update_HangPhuongTien() {
        initComponents();
    }
    
    public Update_HangPhuongTien(String name, String email) {
        this.email = email;
        this.name = name;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Tên Doanh nghiệp :");
    ...
    private void jButton5CommitChange(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5CommitChange
    ...
    }//GEN-LAST:event_jButton5CommitChange
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_HangPhuongTien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_HangPhuongTien().setVisible(true);
            }
        });
    }
