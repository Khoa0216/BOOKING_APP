...
public class SignUpDoanhNghiep extends javax.swing.JPanel {
    ...
    public SignUpDoanhNghiep(JPanel parent, CardLayout cardLayout) {
        initComponents();
        this.parent = parent;
    ...
    public void SetThongTin(NGUOIDUNG nguoidung){
        this.doanhnghiep=new DOANHNGHIEP(nguoidung);
    }
    /**
    ...
    private void SignUp_ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUp_ConfirmActionPerformed
        ...
        this.doanhnghiep.setTENDN(Business_Name_Fill.getText());
        this.doanhnghiep.setDIACHI(Address_Fill.getText());
        this.doanhnghiep.setMOTA(Describe_Mota_Fill.getText());
        
        if (Choose_hotel.isSelected()){
            this.doanhnghiep.setLOAIDN("KHACHSAN");
        } else if (Choose_transportation.isSelected()){
            this.doanhnghiep.setLOAIDN("HANGPHUONGTIEN");
        }
        ...
        if (!Check_condition.isSelected()) {
            ...
            return;
        } else if (this.doanhnghiep.getTENDN().isEmpty() || this.doanhnghiep.getDIACHI().isEmpty() || (!Choose_hotel.isSelected() && !Choose_transportation.isSelected())) {
            JOptionPane.showMessageDialog(this,
                "Bạn phải điền đầy đủ thông tin!",
                "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        Login_SignUp_Check.InsertDOANHNGHIEP(this.doanhnghiep);
